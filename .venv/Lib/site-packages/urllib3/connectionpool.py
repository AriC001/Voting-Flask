...
from urllib3.util.request import _TYPE_BODY_POSITION, set_file_position
from urllib3.util.retry import Retry
from urllib3.util.ssl_match_hostname import CertificateError
from urllib3.util.timeout import _DEFAULT_TIMEOUT, _TYPE_DEFAULT, Timeout
from urllib3.util.url import Url, _encode_target
...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    :param timeout:
        ...
        or an instance of :class:`urllib3urllib3.util.Timeout` which gives you more
        fine-grained control over request timeouts. After the constructor has
        been parsed, this is always a `urllib3urllib3.util.Timeout` object.
    ...
    def _get_timeout(self, timeout: _TYPE_TIMEOUT) -> Timeout:
        """Helper that always returns a :class:`urllib3urllib3.util.Timeout`"""
    ...
    def _make_request(
        ...
        :param retries:
            ...
            :class:`~urllib3urllib3.util.retry.Retry` object for fine-grained control
        ...
        :type retries: :class:`~urllib3urllib3.util.retry.Retry`, False, or an int.

        :param timeout:
            If specified, overrides the default timeout for this one
            request. It may be a float (in seconds) or an instance of
            :class:`urllib3urllib3.util.Timeout`.
...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    is available and are fed into :meth:`urllib3urllib3.util.ssl_wrap_socket` to upgrade
